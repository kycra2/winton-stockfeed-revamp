      ...
      <div className="flex-1 space-y-8">
        ...
        <div className="bg-wsf-cream/60 p-5 rounded-lg mb-2">
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>
              Clients/farm operators can download the latest version of the Delivery Site Agreement <a href={HEALTH_AND_SAFETY_PDF} target="_blank" rel="noopener noreferrer" className="text-wsf-blue underline hover:text-wsf-blue-dark">here</a> at any time for your records.
            </li>
          </ul>
        </div>
