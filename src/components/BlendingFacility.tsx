      ...
      <div className="container-custom">
        ...
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center space-y-6 md:space-y-0 md:space-x-8">
          ...
          <div className="md:w-1/2 space-y-6">
            <p className="text-lg">
              .Our New State Of The Art Blending Facility. We can add in macro minerals, trace minerals and a range of feed additives, saving you time and money (no dusting or dosatron required) so your cows receive their daily requirements.
            </p>
            <p className="text-lg">
